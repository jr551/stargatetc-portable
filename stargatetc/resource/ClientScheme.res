...
Scheme
{
	...
	Colors
	{
		...
		"BrightBaseText"	"0 0 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"0 0 200 255"	// dim base text
		"LabelDimText"		"0 0 200 164"	// used for info text
		"ControlText"		"0 0 255 255"	// used in all text controls
	//	"BrightControlText"	"0 0 255 255"	// use for selected controls
		"BrightControlText"	"255 176 0 255"	// use for selected controls
		"DisabledText1"		"0 0 100 255"	// disabled text
		"DisabledText2"		"0 0 70 0"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"0 0 120 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"0 0 110 255"		// background color of controls
		"ControlDarkBG"		"0 0 110 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"0 0 100 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"0 0 200 255"	// background color of any selected text or menu item
		"SelectionBG2"		"0 0 200 255"		// selection background in window w/o focus
		"ListBG"			"0 0 10 255"		// background of scoreboard
		"ViewportBG"		"0 0 70 255"

		// titlebar colors
		"TitleText"			"0 0 255 255"
		"TitleDimText"		"0 0 200 255"
		"TitleBG"			"0 0 120 0"
		"TitleDimBG"		"0 0 200 255"
		...
		// border colors
		"BorderBright"		"50 50 50 255"	// the lit side of a control
		"BorderDark"		"30 30 30 255"	// the dark/unlit side of a control
		"BorderSelection"	"100 100 100 255"	// the additional border color for displaying the default/selected button

		"team0"			"255 255 255 255"
		"team1"			"124 155 66 255"
		"team2"			"255 0 0 255"
		"team3"			"255 255 0 255"
		"team4"			"0 255 0 255"

		"HintColor"		"255 255 255 255"
		"HintBackgroundColor"	"0 0 0 255"
